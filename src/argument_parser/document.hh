...
static const char vecsz_short_doc[] =
    ...
    "\n"
    "example:\n"
    "  zip 1: ./build/vecsz -t f32 -m r2r -e 1e-4 -i ./data/ex-cesm-CLDHGH -D cesm -z\n"
    "  zip 2: ./build/vecsz -t f32 -m r2r -e 1e-4 -i ./data/ex-cesm-CLDHGH -l 3600,1800 -z\n"
    "  unzip: ./build/vecsz -i ./data/ex-cesm-CLDHGH.sz -x\n"
    "\n"
    "\"vecsz -h\" for details.\n";
...
*/    "*EXAMPLES*\n"
    "    *Demo Datasets*\n"
    "        *CESM* example:\n"
    "        ./build/vecsz -t f32 -m r2r -e 1e-4 -i ./data/ex-cesm-CLDHGH -D cesm -z\n"
    "        ./build/vecsz -t f32 -m r2r -e 1e-4 -i ./data/ex-cesm-CLDHGH -D cesm -r\n"
    "        ./build/vecsz -i ./data/ex-cesm-CLDHGH.sz -x\n"
    "\n"
/*    "        *CESM* example with specified output path:\n"
    "        mkdir data2 data3\n"
    "            # zip, output to `data2`\n"
    "        ./build/vecsz -t f32 -m r2r -e 1e-4 -i ./data/ex-cesm-CLDHGH -D cesm -z --output data2\n"
    "            # unzip, in situ\n"
    "        ./build/vecsz -i ./data2/ex-cesm-CLDHGH.sz -x && ls data2\n"
    "            # unzip, output to `data3`\n"
    "        ./build/vecsz -i ./data2/ex-cesm-CLDHGH.sz -x --output data3 && ls data3\n"
    "            # unzip, output to `data3`, compare to the original datum\n"
    "        ./build/vecsz -i ./data2/ex-cesm-CLDHGH.sz -x --output data3 --origin ./data/ex-cesm-CLDHGH && ls "
    "data3\n"
    "        ## Please create directory by hand before specifying (considering access permission control).\n"
    "\n"
 */   "        *Hurricane Isabel* example:\n"
    "        ./build/vecsz -t f32 -m r2r -e 1e-4 -i ./data/ex-hurr-CLOUDf48 -D hurricane -z\n"
    "        ./build/vecsz -t f32 -m r2r -e 1e-4 -i ./data/ex-hurr-CLOUDf48 -D hurricane -r\n"
    "        ./build/vecsz -i ./data/ex-hurr-CLOUDf48.sz -x\n"
    "\n";
