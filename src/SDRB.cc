...
#ifdef _1D
size_t dims_NYX[]         = {134217728, 1, 1, 1, 1};
size_t dims_QMCPACK1[]    = {157684320, 1, 1, 1, 1};
size_t dims_QMCPACK2[]    = {157684320, 1, 1, 1, 1};
size_t dims_Hurricane[]   = {25000000, 1, 1, 1, 1};
#else
...
size_t* InitializeDemoDims(std::string const& datum, size_t cap, size_t block_size, bool override, size_t new_d0, size_t new_d1, size_t new_d2, size_t new_d3)
{
